...
const API_WEATHER = `https://api.weatherapi.com/v1/current.json?key=25af81d7b5d34ac8ab0122443240706&lang=es&q=`;
...
export default function App() {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${API_WEATHER}${city.trim()}`);
